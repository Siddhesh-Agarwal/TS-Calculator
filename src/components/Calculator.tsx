...
export default function Calculator() {
    ...
    return (
        <div className="container">
            ...
            <div>
                <button className="special" onClick={() => backspace()}> C </button>
                <button className="special" onClick={() => clear()}> CE </button>
                <button className="special" onClick={() => evaluate()}> = </button>
            ...
            <div>
                <button className="number" onClick={() => setValue(value + "00")}> 00 </button>
                <button className="number" onClick={() => setValue(value + "0")}> 0 </button>
                <button className="operator" onClick={() => setValue(value + ".")}> . </button>
                <button className="operator" onClick={() => setValue(value + "*")}> x </button>
            </div>
        </div>
    );
}